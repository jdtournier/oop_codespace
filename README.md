...
The `tree` command displays files and folders recursively and presents them in
a tree structure. This is useful to quickly inspect more complex folder
structures, which we may come across later on:
